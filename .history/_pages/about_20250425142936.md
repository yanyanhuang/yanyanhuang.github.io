...
I am currently a second-year PhD student at [The University of Hong Kong](https://www.hku.hk/), working under the supervision of [Prof. Lequan Yu](https://yulequan.github.io/). Prior to this, I completed my MPhil degree at [Zhejiang University](https://www.zju.edu.cn/) in 2023 and earned my B.Eng degree from [Harbin Institute of Technology](https://www.hit.edu.cn/) in 2020.

My research focuses on the convergence of artificial intelligence and healthcare, where I develop cutting-edge machine learning algorithms for medical applications. I am particularly passionate about creating innovative solutions for healthcare challenges through computational methods. Currently, my primary research direction involves developing advanced deep learning algorithms for whole slide image analysis in digital pathology.

Beyond academic research, I am an avid participant in machine learning competitions and have achieved the rank of [Kaggle Competitions Master](https://www.kaggle.com/rock139) with multiple top placements (🥇×2, 🥈×2) in global competitions.
